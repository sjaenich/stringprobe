...
class LibpcapGroundTruth(GroundTruthExtractor):
    ...
    def __init__(self):
        ...
        self.flags.add(("PCAP_SUPPORT_BT", "False"))
        self.flags.add(("PCAP_SUPPORT_BT_MONITOR", "False"))
        self.flags.add(("PCAP_SUPPORT_DBUS", "False"))
        self.flags.add(("PCAP_SUPPORT_DPDK", "False"))
        self.flags.add(("PCAP_SUPPORT_LINUX_USBMON", "True"))
