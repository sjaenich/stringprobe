...
class RsyncGroundTruth(GroundTruthExtractor):
    ...
    def __init__(self):
        ...
        self.flags.add(("SUPPORT_LZ4", "False"))
        self.flags.add(("SUPPORT_ZSTD", "False"))


        self.flags.add(("SUPPORT_ACLS", "False"))
        self.flags.add(("SUPPORT_XATTRS", "True"))
